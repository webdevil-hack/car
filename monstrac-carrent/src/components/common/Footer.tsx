...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-900 border-t border-dark-800/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              Experience the future of car rentals with our premium fleet, 
              transparent pricing, and world-class service.
            </p>
            <div className="space-y-3">
              <a
                href="mailto:support@monstraccarrent.com"
                className="flex items-center space-x-3 text-gray-400 hover:text-accent-primary transition-colors duration-300"
              >
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className="font-display font-semibold text-white mb-4 capitalize">
                {category}
              </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400">
                Get exclusive deals, new car alerts, and travel tips delivered to your inbox.
              </p>
            </div>
      ...
      {/* Bottom Bar */}
      <div className="bg-dark-950 border-t border-dark-800/50">
              ...
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full bg-dark-800 flex items-center justify-center
                    hover:bg-accent-primary/20 hover:text-accent-primary text-gray-400
